...
<div class="card-container mt-4">
    <div class="row g-3">
        ...
        // Mengambil data menu dengan kategori "Minuman"
        $sql = "SELECT * FROM tbl_cafe WHERE kategori like '%Minuman'";
        ...
        if ($result->num_rows > 0) {
            ...
            echo '<p class="text-center">No menu items found in this category.</p>';
        }
